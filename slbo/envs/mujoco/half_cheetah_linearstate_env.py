import math
import numpy as np
from rllab.envs.mujoco import half_cheetah_linearstate_env
from slbo.envs import BaseModelBasedEnv
from slbo.utils.flags import FLAGS

HalfCheetahLinearStateConfig = half_cheetah_linearstate_env.HalfCheetahLinearStateConfig

class HalfCheetahLinearStateEnv(half_cheetah_linearstate_env.HalfCheetahLinearStateEnv, BaseModelBasedEnv):
    ...
    def mb_step(self, states, actions, next_states):
        ...
        reward_run = np.sum(norm_next_states * self._task_config.goal_velocity * self._task_config.coef, axis=1)
