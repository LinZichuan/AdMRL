...
@click.option('--taskname', default='Ant3D')
...
@click.option('--nsample', default=8000)
@click.option('--fixedvel', default=None)
@click.option('--initnslbo', default=1)
@click.option('--nslbo', default=1)
@click.option('--warmniter', default=1)
@click.option('--slboniter', default=1)
@click.option('--piter', default=20)
@click.option('--miter', default=1000)
@click.option('--atype', default='adv') # gae, 1step, ret
@click.option('--video', is_flag=True, default=False)
@click.option('--maxstep', default=1)
@click.option('--genadvstrategy', default=None)
@click.option('--inittask', default='inittask')
